...
function App() {
  ...
  let [events, updateEvents] = useState([{title: "Aerial hoop class", start: 18, duration: 2.5}, {title: "Laka Interview", start: 14.5, duration: 1}, {title: "Yoga", start: 9, duration:2}])
